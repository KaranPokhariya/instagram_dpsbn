...
options.add_extension("/Users/rachitbansal/Downloads/instagram_dpsbn/extension.crx")
...
username.clear()
username.send_keys("slickapp2022")
password.clear()
password.send_keys("9852351061")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/rachitbansal/Downloads/{}_followers.csv /Users/rachitbansal/Downloads/instagram_dpsbn/accounts'.format(account))
        except:
